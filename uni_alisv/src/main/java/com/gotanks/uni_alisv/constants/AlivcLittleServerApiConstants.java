package com.gotanks.uni_alisv.constants;
...
public class AlivcLittleServerApiConstants {
     ...
     *获取视频上传凭证
     */
    public static final String URL_GET_VIDEO_UPLOAD_AUTH = BASE_URL + "/vod/auth/getVideoUploadAuth";
    /**
     * 刷新视频上传凭证
     */
    public static final String URL_REFRESH_VIDEO_UPLOAD_AUTH = BASE_URL + "/vod/auth/refreshVideoUploadAuth";
    /**
     * 获取图片上传凭证
     */
    public static final String URL_GET_IMAGE_UPLOAD_AUTH = BASE_URL + "/vod/auth/getImageUploadAuth";
}
